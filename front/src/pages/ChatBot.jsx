...
function ChatBot() {
  ...
  const sendChat = async (chat) => {
    setChattingList((prevList) => [
      ...prevList,
      { user: "user", chat: chat, imgURL: null, move: null },
    ]);
    setChattingList((prevList) => [
      ...prevList,
      { user: "bot", chat: "loading", imgURL: null, move: null },
    ]);
      ...
      <div className="chatbot-body">
        ...
        <div className="chatbot-chat-container">
          <div className="chatbot-recommend-div">
            ...
            <div className="recommend-ment">
              낚시왕 추천, 똑똑하게 낚시하자!
            </div>
            {recommendList.map((recChat, idx) => (
              <div
                className="chatbot-recommend"
                key={idx}
                onClick={handleClickRecChat}
              >
                {recChat}
              </div>
            ))}
