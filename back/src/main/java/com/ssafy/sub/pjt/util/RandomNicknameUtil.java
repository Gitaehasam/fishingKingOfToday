...
public class RandomNicknameUtil {
    ...
    static List<String> adjective =
            Arrays.asList(
                    "아름다운", "귀여운", "활기찬", "뛰어난", "창조적인", "열심히하는", "친절한", "충실한", "유능한", "매력적인",
                    "차분한", "자신감있는", "명랑한", "적극적인", "성실한", "참신한", "감동적인", "훌륭한", "놀라운", "화려한",
                    "기뻐하는", "독특한", "재치있는", "존경스러운", "기분좋은", "흥미진진한", "즐거운", "진실한", "따뜻한", "다정한",
                    "자상한", "사랑스러운", "열정적인", "고요한", "밝은", "신나는", "행복한", "멋진", "훈훈한");
